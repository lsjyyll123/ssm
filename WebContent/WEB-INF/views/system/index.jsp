...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
	...
	<div class="wu-sidebar" data-options="region:'west',split:true,border:true,title:'导航菜单'"> 
    	<div class="easyui-accordion" data-options="border:false,fit:true"> 
        	...
        	<div title="${topMenu.name }" data-options="region:'west',split:true,border:true,title:'${topMenu.name }',iconCls:'${topMenu.icon }'"   style="padding:5px;">  	
           ...
           <%-- <div class="easyui-accordion" data-options="border:false,fit:true"> 
            	<div title="系统设置" data-options="region:'west',split:true,border:true,title:'系统设置'"   style="padding:5px;">  	
	    			<ul class="easyui-tree wu-side-tree">
	                			<li iconCls="icon-application-side-boxes"><a href="javascript:void(0)" data-icon="icon-application-side-boxes" data-link="../admin/menu/list" iframe="1">菜单管理</a></li>
	                </ul>
	    			<ul class="easyui-tree wu-side-tree">
	                			<li iconCls="icon-group32"><a href="javascript:void(0)" data-icon="icon-group32" data-link="../admin/role/list" iframe="1">角色管理</a></li>
	                </ul>
                </div>
            	<div title="用户管理" data-options="region:'west',split:true,border:true,title:'用户管理'"   style="padding:5px;">  	
	    			<ul class="easyui-tree wu-side-tree">
	                			<li iconCls="icon-user"><a href="javascript:void(0)" data-icon="icon-user" data-link="../admin/user/list" iframe="1">用户管理</a></li>
	                </ul>
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2019 【xxxx】 All Rights Reserved
    </div>
    <!-- end of footer -->  
