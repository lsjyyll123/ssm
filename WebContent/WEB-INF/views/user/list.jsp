	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td valign="middle"  >
                	<img id="preview-photo" style="float:left;height:60px;width:60px;" src="/UserManager/resources/admin/easyui/images/user_photo.jpg"  >
                	<a style="float:left; margin-top: 15px;  margin-left: 15px;  " href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-upload" onclick="uploadPhoto()" plain="true">上传图片</a>
                </td>
            </tr>
            <tr>
                <td width="60" align="right">头像:</td>
                <td><input type="text" id="add-photo" name="photo" value="/UserManager/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="age" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:1,precision:0,max:200, missingMessage:'请填写年龄'" /></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td width="60" align="right">头像:</td>
                <td><input type="text" id="edit-photo" name="photo" value="/UserManager/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
                <td width="60" align="right">用户名:</td>
...
<script type="text/javascript">
	...
	*/
	function remove(){
		...
		if(item.length == 0){
			$.messager.alert('信息提示','请选择至少一条数据！','info');
			return;
		}
	...
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'photo',title:'用户头像',width:100,align:'center',formatter:function(value,row,index){
				var img = '<img src="'+value+'" style=" width:40px;" />';
				return img;
			}},
